...
function WeddingPage() {
  ...
  const WeddingGifts = allGifts.filter((gift) =>
    gift.categories.includes(3)
  );

  return (
    <div className="flex flex-col justify-center align-center space-y-8 m-12">
      <div className="bg-[url('src/assets/Images/pexels-pixabay-59948.jpg')] bg-cover bg-center flex justify-center items-center h-full">
