...
function SalePage() {
  ...
  const SaleGifts = allGifts.filter((gift) =>
    gift.categories.includes(4)
  );

  return (
    <div className="flex flex-col justify-center align-center space-y-8 m-12">
      <div className="bg-[url('src/assets/Images/pexels-photo-301673.Webp')] bg-cover bg-center flex justify-center items-center h-full">
