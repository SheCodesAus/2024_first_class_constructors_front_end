  ...
  return (
    <div className="bg-primary-400 mt-6 relative">
      <div className="flex flex-auto items-center relative">
        ...
        <div className="absolute top-22 left-9 right-9 bottom-3 lg:top-60 lg:left-60 lg:right-60 lg:bottom-45 flex flex-col justify-center items-center bg-slate-100 gap-2 xl:my-60 xl:mx-60">
          <img
            src="src/assets/Images/GIFT_COMPARE_LOGO.svg"
            alt="Footer Logo"
            className="w-40 h-35 bg-slate-100 px-14 py-4"
          />
